						...
						<?php
							foreach($items as $item) {
								echo "<tr>";
									...
									echo "<td>
										<a href='items.php?do=Edit&itemid=" . $item['id'] . "' class='btn btn-success'><i class='fa fa-edit'></i> </a>
										<a href='items.php?do=Delete&itemid=" . $item['id'] . "' class='btn btn-danger confirm'><i class='fa fa-trash'></i>  </a>";
										if ($item['approve'] == 0) {
											echo "<a 
                                            ...
                                            echo "<a 
													href='items.php?do=Unapprove&itemid=" . $item['id'] . "' 
		...
		<?php 
			...
			<div class="container">
				<form class="form-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group form-group-lg">
                        ...
                        users from the vendor should be displayed below.
						<div class="col-sm-10 col-md-6">
							<select name="member">
								<option value="0">...</option>
								<?php
									$allMembers = all("*", "users", "", "", "id");
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-6">
							<select name="category">
								<option value="0">...</option>
								<?php
									$allCats = all("*", "categories", "where parent = 0", "", "id");
									foreach ($allCats as $cat) {
										echo "<option value='" . $cat['id'] . "'>" . $cat['name'] . "</option>";
										$childCats = all("*", "categories", "where parent = {$cat['id']}", "", "id");
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if (empty($formErrors)) {
					...
					$stmt = $con->prepare("INSERT INTO 
						...
						items(name, description, price, country_made, status, created_at, cat_id, user_id, tags,image)
			...
			if ($count > 0) { ?>
				...
				<div class="container">
					<form class="form-horizontal" action="?do=Update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10 col-md-6">
                            ...
                            if (empty($item['image'])) {
                                ...
                                echo "<img src='uploads/items/" . $item['image'] . "' alt='' />";
                            }
                            ?>
                            <input type="file" name="image" class="form-control" required="required" />
                        </div>
					...
					?>
					<h1 class="text-center">User [ <?php echo $item['name'] ?> ] Comments</h1>
					<div class="table-responsive">
						<table class="main-table text-center table table-bordered">
							<tr>
								<td>Comment</td>
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if (empty($formErrors)) {
					...
					$stmt->execute(array($name, $desc, $price, $country, $image, $status, $cat, $user, $tags, $id));
					// Echo Success Message
			...
			echo "<h1 class='text-center'>Un -approve Item</h1>";
			echo "<div class='container'>";
				...
				if ($check > 0) {
					...
					$theMsg = "<div class='alert alert-success'>" . $stmt->rowCount() . ' Record Deactivated</div>';
